        ...
        private void InitReport()
        {
            if (File.Exists(FileName))
            {
                using (var sw = new StreamWriter(FileName, true))
                {
                    ...
                    sw.WriteLine("      <title>Selenium Test Report</title>");
                    ...
                    sw.WriteLine("        <td class=bborder_left>" + BrowserObjects.SBrowserName.ToUpperInvariant() +
                                 "</td>");
                    sw.WriteLine("       </tr>");
                    sw.WriteLine("       <tr>");
                    sw.WriteLine("        <td class=bborder_left>Browser Version</td>");
                    sw.WriteLine("        <td class=bborder_left>" + BrowserObjects.BrowserVersion.ToUpperInvariant() +
                                 "</td>");
                    sw.WriteLine("       </tr>");
                    sw.WriteLine("       <tr>");
                    sw.WriteLine("         <td class=bborder_left>Selenium Version</td>");
                    sw.WriteLine("        <td class=bborder_left>" + Assembly.GetExecutingAssembly().GetName().Version +
                                 "</td>");
                    sw.WriteLine("       </tr>");
                    sw.WriteLine("         <tr>");
                    ...
                    sw.WriteLine("        <td class=bborder_left>" + string.Format("{0:yyyyMMdd-hhmmss}", DateTime.Now) +
                                 "</td>");
                    sw.WriteLine("       </tr>");
                    sw.WriteLine("      </table> ");
